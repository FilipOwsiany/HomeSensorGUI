...
class CSidePanel : public CObject, public CCallbackInterface
{
private:
...
public:
    ...
    CSidePanel(CCallbackInterface& aCallbackInterface, lv_obj_t * aParent = nullptr, int32_t aX = 0, int32_t aY = 0, int32_t aWidth = 100, int32_t aHeight = 100);
    ~CSidePanel();
};
